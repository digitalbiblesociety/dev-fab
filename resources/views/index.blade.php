...
@section('main')
    ...
    <div id="map1">
        ...
        <div class="continent-nav row">
            ...
            <a class="small-2 australia" title="{{trans('fab.index.australia')}}">
            ...
            <a class="small-2 northamerica" title="{{trans('fab.index.northAmerica')}}">
            ...
            <a class="small-2 southamerica" title="{{trans('fab.index.southAmerica')}}">
            ...
            <a class="small-2 asia" title="{{trans('fab.index.asia')}}">
            ...
            <a class="small-2 europe" title="{{trans('fab.index.europe')}}">
    ...
    <div class="world-watch-list-key row">
        <div class="small-3 extreme">{{ trans('fab.index.extremePersecution') }}</div>
        <div class="small-3 severe">{{ trans('fab.index.severePersecution') }}</div>
    </div>
