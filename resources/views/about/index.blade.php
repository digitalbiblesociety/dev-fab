...
@section('main')
    ...
    <section class="medium-mt2">
        ...
        <div class="medium-6 row">
            <div class="medium-2 flex-center">
                <img class="small-8" src="/img/about/symposium.svg" />
            </div>
            <div class="medium-10">
        ...
        <div class="medium-6 row">
            <div class="medium-2 flex-center">
                <img class="small-8" src="/img/about/help.svg" />
            </div>
            <div class="medium-10">
        ...
        <div class="medium-6 row">
            <div class="medium-2 flex-center">
                <img class="small-8" src="/img/about/faq.svg" />
            </div>
            <div class="medium-10">
        ...
        <div class="medium-6 row">
            <div class="medium-2 flex-center">
                <img class="small-8" src="/img/about/feedback.svg" />
            </div>
            <div class="medium-10">
